...
export default function LabProductSections() {
  return (
    <ProductSectionCollection
      sections={[
        { id: "lab-featured", title: "Popular Health Products", subtitle: "20 products selected from data.json", href: "/lab", minimumCards: 20, background: "#f3fbff", headingColor: "#086f83" },
