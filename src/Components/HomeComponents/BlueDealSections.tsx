  ...
  return (
    <>
      <section className="relative w-full overflow-hidden bg-[#eaf3fd] py-10 sm:py-12 lg:py-14">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute -left-32 top-0 h-96 w-96 rounded-full bg-white/50 blur-3xl"
        />

        <div
          aria-hidden="true"
          className="pointer-events-none absolute -right-32 bottom-0 h-96 w-96 rounded-full bg-[#d8e9fc]/70 blur-3xl"
        />
      ...
      <style jsx global>{`
        ...
        @media (prefers-reduced-motion: reduce) {
          .blue-deal-scroll,
          .blue-deal-scroll *,
          .blue-deal-scroll *::before,
          .blue-deal-scroll *::after {
    ...
    <section>
      ...
      <div className="relative">
        ...
        <div
          ...
          className="blue-deal-scroll flex snap-x snap-mandatory gap-4 overflow-x-auto pb-3"
        >
          {loading &&
            Array.from({
...
function ProductCard({
  ...
  return (
    <article
      data-product-card
      className="blue-deal-product-card group flex shrink-0 snap-start flex-col overflow-hidden rounded-[9px] border border-[#dfe4e8] bg-white shadow-[0_7px_18px_-16px_rgba(15,23,42,0.45)] transition-all duration-300 hover:-translate-y-1 hover:border-[#bad9d5] hover:shadow-[0_22px_40px_-26px_rgba(15,23,42,0.4)]"
    >
      <Link
        href={product.href}
...
function ProductSkeleton() {
  return (
    <div className="blue-deal-product-card shrink-0 overflow-hidden rounded-[9px] border border-[#e4e7ec] bg-white">
...
function EmptyState() {
  return (
    <div className="flex min-h-[360px] w-full items-center justify-center rounded-xl border border-[#dce4eb] bg-white px-6 text-center">
      <div>
        <ShoppingCart
          size={34}
