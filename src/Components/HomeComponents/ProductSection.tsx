    ...
    <article data-hc-card className="hc-card">
      ...
      <div className="hc-content">
        ...
        <div className="hc-price-row">
          ...
          <button type="button" onClick={openDetails} aria-label={`Open details for ${product.name}`}>
            ADD
          </button>
        </div>
      </div>
