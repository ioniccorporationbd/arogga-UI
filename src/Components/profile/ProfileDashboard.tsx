...
export default function ProfileDashboard({ section: sectionProp }: { section?: ProfileSection }) {
  ...
  async function quickAction(payload: Record<string, unknown>) {
    ...
    toast.success(`${copy[section].action} completed`);
    setModal("");
  }
